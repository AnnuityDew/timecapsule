...
<main>
    ...
    <!-- <span id="jiggle0" class="jc"> -->
        ...
        <p class="white">
            WoW, lOOK at All oF thE rANdoM sTuff...hoW wiLL You eVer sUrviVe? (I'll
            just tell you: click the Home button. Duh...)
        </p>
        <center>
...
<footer>
    ...
    <p>Credit to <a href="https://www.dynamicdrive.com">Dynamic Drive</a>
    ...
    <p>
        Also, thanks to <a href="https://www.astronomy.swin.edu.au/~pbourke/fractals/">
            Fractals, Chaos</a> for the background of The Page of Insanity.
    </p>
    ...
    <p>
        And one final note: if you don't recognize the name of some of the colleges and institutions that
        I talk about, you probably don't live in Virginia Beach. :)
    </p>
</footer>
</div>
